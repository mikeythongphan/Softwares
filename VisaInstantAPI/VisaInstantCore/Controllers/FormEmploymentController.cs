...
namespace VisaInstantCore.Controllers
{
    ...
    [Authorize]
    public class FormEmploymentController : ControllerTableBase<FormEmployment, long>
    {

        /// <summary>
        /// 
        /// </summary>
        public FormEmploymentController(IFormEmploymentRepository repos)
            : base(repos)
        {
        }
        ...
        [HttpPost]
        [Route("Insert")]
        public override IActionResult Insert([FromBody] FormEmployment obj)
        {
