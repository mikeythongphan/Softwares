...
import { FormControl, FormGroup, Select, MenuItem, Button, FormControlLabel, FormLabel, InputLabel, Radio, RadioGroup, TextField, Check, Checkbox } from "@mui/material";
...
export const SponsorLanguages = (props) => {
  ...
  return (
    <>
      ...
      />
      <FormControl>
        <Button variant="contained" style={{ backgroundColor: "green", width: "230px" }}>+ Add Another Language</Button>
      </FormControl>
    </>
  )
}