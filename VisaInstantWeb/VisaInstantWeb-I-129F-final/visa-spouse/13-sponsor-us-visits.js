...
import { FormControl, FormGroup, Button, Select, MenuItem, FormControlLabel, FormLabel, InputLabel, Radio, RadioGroup, TextField, Check, Checkbox } from "@mui/material";
...
export const SponsorUSVisits = (props) => {
  ...
  return (
    <>
      ...
      <FormControl>
        <Button variant="contained" style={{ backgroundColor: "green", width: "190px" }}>+ Add another visit</Button>
      </FormControl>
    </>
  )
}